...
`).join('');
    ...
    prepareCompleteSettings(settingsToUse) {
        ...
        const completeSettings = {
            ...
            matrixColor1: settingsToUse.matrixColor1 || '#38bdf8',
            matrixColor2: settingsToUse.matrixColor2 || '#2563eb',
            sequence: settingsToUse.sequence || 'HAPPY|BIRTHDAY|MY|CUTEE|LITTLE|SWARALI|❤',
            sequenceColor: settingsToUse.sequenceColor || '#60a5fa',
    ...
    getCurrentSettingsFromModal() {
        ...
        try {
            ...
            const modalSettings = {
                ...
                matrixColor1: document.getElementById('matrixColor1')?.value || '#38bdf8',
                matrixColor2: document.getElementById('matrixColor2')?.value || '#2563eb',
                sequence: document.getElementById('sequenceText')?.value || 'HAPPY|BIRTHDAY|MY|CUTEE|LITTLE|SWARALI|❤',
                sequenceColor: document.getElementById('sequenceColor')?.value || '#60a5fa',
