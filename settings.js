...
let settings = {
    ...
    matrixColor1: '#38bdf8', // Blue theme
    matrixColor2: '#2563eb', // Blue theme
    sequence: 'HAPPY|BIRTHDAY|TO|ZIN ZIN ZAW WAI|❤',
    sequenceColor: '#60a5fa', // Blue theme
    ...
    pages: [
        ...
        { 
            image: './image/p3.jpg', // Menggantikan lhvuck.png (Index 1)
        },

        // --- Lembar 2 (data-page="1") ---
        { 
            image: './p2.jpg', // Menggantikan fjr3qh.png (Index 2)
            content: 'Happy Birthday  💗' 
        },
        { 
            image: './p4.jpg', // Menggantikan 8u5tf7.png (Index 3)
        },

        // --- Lembar 3 (data-page="2") ---
        { 
            image: 'https://madeforanita.vercel.app/image/theend.jpg', // Menggantikan tbutvj.jpg (Index 4)
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            { 
                image: './p3.jpg', // Menggantikan lhvuck.png (Index 1)
            },
...
function detectCurrentColorTheme() {
    ...
    // Default to the blue theme when no exact preset is found
    return 'blue';
}
...
function createPages() {
    ...
    for (let physicalPageIndex = 0; physicalPageIndex < totalPhysicalPages; physicalPageIndex++) {
        ...
        if (backLogicalIndex < pages.length && pages[backLogicalIndex]) {
            ...
            endImg.src = 'https://madeforanita.vercel.app/image/theend.jpg';
            endImg.alt = 'The end';
